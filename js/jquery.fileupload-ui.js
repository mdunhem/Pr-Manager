 ...
 *
 * Slightly modified by Mikael Dunhem for use with
                ...
                that._transition(data.context).done(
                    function () {
						...
						submit: function (e, data) {
							...
							var date = inputs.filter('[name="date[]"]').first().focus().val();
...
//							};
							if (inputs.filter('[required][value=""]').first().focus().length) {
									return false;
							} else if (!dateFormat.exec(date)) {
									alert("Invalid date format. Please enter as \"MM/DD/YYYY\"");
									return false;
							}
